...
class UpdateKTHRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return auth()->check() &&
               auth()->user()->role === 'penyuluh' &&
               $kth && $kth->id_penyuluh === auth()->user()->penyuluh->id;
    }

    public function rules(): array
    {
        $kthId = $this->route('kth') ? $this->route('kth')->id : null;
        ...
        return [
            ...
            'nama_kth' => [
                ...
                'string',
                'max:255',
                Rule::unique('kth', 'nama_kth')->ignore($kthId),
            ],
            ...
            'nomor_register' => [
                ...
                'string',
                'max:100',
                Rule::unique('kth', 'nomor_register')->ignore($kthId),
            ],
            ...
            // Tahun tidak aktif - WAJIB JIKA status = Tidak Aktif
