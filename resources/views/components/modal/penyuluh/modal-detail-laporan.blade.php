...
@if ($laporan)
            ...
            <div class="bg-white border-t border-stone-300/20 py-3 px-6 sticky bottom-0 flex-shrink-0">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        @if ($laporan->status_verifikasi == 'rejected')
                            <button type="button" onclick="openEditLaporanFromDetail({{ $laporan->id }})"
    ...
    <script>
        ...
        // ============================================
        // 🔥 FUNGSI BUKA MODAL EDIT DARI DETAIL
        // ============================================
        window.openEditLaporanFromDetail = function(laporanId) {
            console.log('Opening edit from detail modal for laporan ID:', laporanId);
            ...
            if (typeof openEditLaporanModal === 'function') {
                // Beri waktu sedikit untuk animasi tutup modal
                requestAnimationFrame(function() {
                    openEditLaporanModal(laporanId);
                });
            } else {
                console.error('Fungsi openEditLaporanModal tidak ditemukan!');
                alert('Fungsi edit laporan tidak ditemukan. Pastikan modal laporan sudah di-include.');
            }
        };
