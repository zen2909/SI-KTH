...
<dialog id="modalExportKTHPimpinan"
    ...
    <div class="bg-white rounded-3xl flex flex-col max-h-[90vh]">
        ...
        <div
            ...
            <button type="button" onclick="closeModalExportKTHPimpinan()"
        ...
        <div class="overflow-y-auto flex-1 px-6 py-4 max-h-[600px]">
            ...
            <form id="formExportKTHPimpinan" action="{{ route('pimpinan.kth.export') }}" method="POST"
                ...
                <div>
                    ...
                    <div class="relative mt-1">
                        <input type="text" id="searchKTHInputPimpinan" name="search"
                ...
                <div>
                    ...
                    <select id="kecamatanSelectPimpinan" name="kecamatan"
                    ...
                    <div class="flex flex-wrap gap-2 mt-1">
                        <label
                            ...
                            <input type="checkbox" name="status_verifikasi[]" value="pending"
                                class="status-checkbox-pimpinan w-3.5 h-3.5 text-emerald-900 rounded focus:ring-emerald-900">
                ...
                <div class="flex items-center gap-3 p-3 bg-green-800/10 rounded-xl border border-green-800/20">
                    ...
                    <div>
                        ...
                        <p class="text-green-900 text-sm font-normal font-['Inter']" id="totalDataDisplayPimpinan">
                            Total <span class="font-bold"
                                id="totalDataCountPimpinan">{{ number_format($totalData) }}</span> data KTH
                        </p>
                        <p class="text-xs text-neutral-500 mt-0.5" id="filterStatusDisplayPimpinan">Semua status</p>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div
            ...
            <div class="flex items-center gap-2">
                <button type="button" onclick="resetFilterExportPimpinan()"
                ...
                <button type="submit" form="formExportKTHPimpinan"
...
<script>
    // ============================================
    // AUTO COMPLETE SEARCH KTH PIMPINAN
    // ============================================
    (function() {
        var searchInput = document.getElementById('searchKTHInputPimpinan');
        var searchResult = document.getElementById('searchResultPimpinan');
        var searchResultList = document.getElementById('searchResultListPimpinan');
        var typingTimer;
                            ...
                            data.forEach(function(item) {
                                ...
                                html += `
                                    <div class="px-4 py-2 hover:bg-gray-100 cursor-pointer border-b border-stone-100 last:border-0"
                                        onclick="selectSearchResultPimpinan('${item.nama_kth}')">
    ...
    function selectSearchResultPimpinan(name) {
        var searchInput = document.getElementById('searchKTHInputPimpinan');
        var searchResult = document.getElementById('searchResultPimpinan');
        if (searchInput) {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var form = document.getElementById('formExportKTHPimpinan');
    ...
    function updateTotalDataPimpinan() {
        var form = document.getElementById('formExportKTHPimpinan');
        ...
        var url = '/pimpinan/kth/export-count?' + searchParams.toString();
        ...
        fetch(url)
            ...
            .then(function(data) {
                var countDisplay = document.getElementById('totalDataCountPimpinan');
                var statusDisplay = document.getElementById('filterStatusDisplayPimpinan');
                ...
                if (statusDisplay) {
                    var statuses = [];
                    var checkboxes = document.querySelectorAll('.status-checkbox-pimpinan:checked');
                    checkboxes.forEach(function(cb) {
                        statuses.push(cb.value.charAt(0).toUpperCase() + cb.value.slice(1));
                    });

                    var kecamatan = document.getElementById('kecamatanSelectPimpinan').value;
                    var search = document.getElementById('searchKTHInputPimpinan').value;
    ...
    // ============================================
    document.addEventListener('DOMContentLoaded', function() {
        var excelOption = document.getElementById('excelOptionPimpinan');
        var pdfOption = document.getElementById('pdfOptionPimpinan');
    ...
    // FUNGSI BUKA MODAL
    // ============================================
    window.openModalExportKTHPimpinan = function() {
        var modal = document.getElementById('modalExportKTHPimpinan');
        if (modal) {
            modal.showModal();
    ...
    // FUNGSI TUTUP MODAL
    // ============================================
    function closeModalExportKTHPimpinan() {
        var modal = document.getElementById('modalExportKTHPimpinan');
        if (modal) {
            modal.close();
    ...
    // FUNGSI RESET FILTER
    // ============================================
    function resetFilterExportPimpinan() {
        var form = document.getElementById('formExportKTHPimpinan');
        if (form) {
            form.reset();
            ...
            document.getElementById('searchKTHInputPimpinan').value = '';
            document.getElementById('searchResultPimpinan').classList.add('hidden');
            updateTotalDataPimpinan();
        }
    }
