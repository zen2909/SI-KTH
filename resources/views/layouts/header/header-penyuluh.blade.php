...
@elseif (request()->routeIs('penyuluh.kth.index'))
    <h2 class="text-xl font-poppins font-semibold text-primary">Data KTH Saya</h2>
@elseif (request()->routeIs('penyuluh.laporan.index'))
    <h2 class="text-xl font-poppins font-semibold text-primary">Data Laporan Saya</h2>
