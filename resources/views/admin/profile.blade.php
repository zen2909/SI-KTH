            ...
            <div class="col-span-1">
                <div
                    ...
                    <div class="relative mb-4">
                        <div
                            class="w-32 h-32 rounded-full border-4 border-green-200 shadow-[0px_0px_0px_8px_rgba(14,76,52,0.05)] flex items-center justify-center bg-gray-100 overflow-hidden">
                            @if ($user->foto_profil)
                    ...
                    {{-- Role Badge --}}
                    <div class="mt-3 px-4 py-1.5 bg-primary rounded-full">
                        @php
                            $roleLabels = [
                                'admin' => 'Administrator',
                                'penyuluh' => 'Penyuluh',
                        ...
                        @endphp
                        <span class="text-white text-sm font-medium font-inter">
