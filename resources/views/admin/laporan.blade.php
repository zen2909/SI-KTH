        ...
        <div class="self-stretch grid grid-cols-4 gap-4">
            <div class="p-6 bg-white rounded-3xl border-l-4 border-emerald-900 shadow-[0px_4px_20px_-2px_rgba(0,0,0,0.05)]">
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-neutral-700 text-sm font-normal font-['Inter']">Total Laporan</p>
                ...
                <div class="flex items-center gap-2 mt-2">
                    <span class="text-emerald-900 text-sm font-['Inter']">Seluruh laporan dari semua KTH</span>
                </div>
            </div>

            <div class="p-6 bg-white rounded-3xl border-l-4 border-zinc-600 shadow-[0px_4px_20px_-2px_rgba(0,0,0,0.05)]">
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-neutral-700 text-sm font-normal font-['Inter']">Diverifikasi</p>
                        <p class="text-zinc-600 text-4xl lg:text-5xl font-bold font-['Poppins'] leading-[57.60px]">
                            {{ number_format($totalVerified) }}
                        </p>
                    </div>
                    <div class="px-3 py-2.5 bg-gray-300 rounded-xl">
                ...
                <div class="flex items-center gap-2 mt-2">
                    ...
                    <span class="text-zinc-600 text-sm font-['Inter']">Laporan telah diverifikasi</span>
                </div>
            </div>

            <div class="p-6 bg-white rounded-3xl border-l-4 border-amber-500 shadow-[0px_4px_20px_-2px_rgba(0,0,0,0.05)]">
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-neutral-700 text-sm font-normal font-['Inter']">Menunggu</p>
                        <p class="text-amber-600 text-4xl lg:text-5xl font-bold font-['Poppins'] leading-[57.60px]">
                            {{ number_format($totalPending) }}
                        </p>
                    </div>
                    <div class="px-3 py-2.5 bg-amber-100 rounded-xl">
            ...
            <div class="p-6 bg-white rounded-3xl border-l-4 border-red-700 shadow-[0px_4px_20px_-2px_rgba(0,0,0,0.05)]">
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-neutral-700 text-sm font-normal font-['Inter']">Ditolak</p>
                        <p class="text-red-700 text-4xl lg:text-5xl font-bold font-['Poppins'] leading-[57.60px]">
                            {{ number_format($totalRejected) }}
                        </p>
                    </div>
                    <div class="px-3 py-2.5 bg-rose-200 rounded-xl">
                ...
                <div class="flex items-center gap-2 mt-2">
                    ...
                    <span class="text-red-700 text-sm font-['Inter']">Perlu diperbaiki</span>
                </div>
            </div>
        </div>
